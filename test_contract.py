...
class ContractTest(unittest.TestCase):
    ...
    def test_known_action_count_is_seventeen(self):
        self.assertEqual(17, len(load_actions()))

    def test_lua_handlers_count_is_seventeen(self):
        self.assertEqual(17, len(handlers_in_lua()))

    def test_client_action_count_is_seventeen(self):
        self.assertEqual(17, len(client_actions()))
