...
- Mục tiêu hoàn thành giai đoạn học hỏi: **phóng rocket đầu tiên** bằng tài nguyên thật, không spawn miễn phí. **Mục tiêu cuối dự án** là bộ công cụ + tài liệu bàn giao được cho bất kỳ AI nào để chơi như kỹ sư thực thụ; rocket là bài kiểm tra tích hợp, chưa đủ để tuyên bố toolkit hoàn tất. Tuy nhiên maintainer vừa báo **sinh vật bản địa bắt đầu tấn công** và ra lệnh **DỪNG mọi xây dựng/chế tạo đang làm; chuyển ưu tiên ngắn hạn sang phòng thủ**. Chưa biết khu vực bị đánh. Agent tiếp theo phải hỏi/khảo sát tình hình trước khi tác động, không tiếp tục Green Science hay thu gom vật tư theo kế hoạch cũ.
...
- Điểm chưa giải quyết: nguồn sắt đang thiếu so với nhu cầu (audit 10 phút: 112.5 plate/phút sản xuất, 139.8 tiêu thụ); Green Science chưa được agent xây. Nhưng **phòng thủ hiện ưu tiên cao hơn**, không sửa công nghiệp cho tới khi tình hình tấn công rõ và maintainer cho phép tiếp tục.
